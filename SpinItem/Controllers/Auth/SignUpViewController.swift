...
class SignUpViewController: UIViewController, UITextFieldDelegate {
    ...
    func loadSubviews() {
        ...
        self.scrollView.addSubview(self.usernameLine)
    ...
    func configureSubviews() {
        ...
        usernameField.addTarget(self, action: #selector(textFieldChanged(_:)), for: UIControlEvents.editingChanged)
        usernameField.textContentType = UITextContentType.username
        usernameField.keyboardType = UIKeyboardType.emailAddress
        usernameField.font = UIFont.systemFont(ofSize: 18, weight: UIFont.Weight.regular)
    ...
    override func viewWillLayoutSubviews() {
        ...
        usernameLabel.frame = CGRect(x: 48, y: y, width: screen.width - 96, height: 17)
        y += 29
        usernameField.frame = CGRect(x: 48, y: y, width: screen.width - 96, height: 22)
        usernameLine.frame = CGRect(x: 48, y: y + 26, width: screen.width - 96, height: 1)
        y += 44
    ...
    @objc func handleSignUp() {
        ...
        SPAuth.auth().createUser(withEmail: email, username: username, password: pass) { user, error in
